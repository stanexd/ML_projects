...
class KNN:
    ...
    def compute_distances_no_loops(self, X):
        ...
        abs_diff = np.abs(self.train_X - X_expanded)
    ...
    def predict_labels_binary(self, dists):
        ...
        for i in range(num_test):
            ...
            values = self.train_y[indices]
            #получаем уникальные значения и их частоту для k соседей
            unique_values, counts = np.unique(values, return_counts=True)
            #получаем самое частое значение (True или False)
